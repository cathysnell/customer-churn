...
```console
$ python -m datagen --sample-frac 0.004 --months 18 --out data/sample --format parquet --no-partitions --evidence evidence/datagen-sample-run.md --quiet
```
...
monthly churn rate of **4.6965%**
against the configured target of **4.7000%**.
...
| `crm_touches` | VA (CRM touch + reactivation outcome) | bronze | 1,109 | one row per campaign touch sent to a user |
...
| --- | --- | --- |
| Pro monthly churn rate | 4.70% | **4.696%** |
| CRM winback reactivation rate | 8.00% | **7.602%** |
| Power-user share (>=4 hrs/day on >=5 days/wk) | segment definition | **29.50%** of users |
| Users who churned at least once in the window | — | **48.50%** |
| `usage_events` density (rows / (users x days)) | active days only | **39.63%** |
...
| `power_user_flag` | `bool` | `BOOLEAN` | no | TRUE if the user ever sustained >=4 coding hours/day on >=5 days in a calendar week (the brief's power-user bar). |
...
TCK-000000002 USR-00000158   2025-03-08     in_app_chat   indexing_failure    P3_low                   5                     495             93.06               0         False         4.0      True
TCK-000000003 USR-00000093   2025-03-12           email suggestion_quality P2_normal                   7                     162             54.53               1         False         NaN      True
...
CMP-003          182          0.9396     0.3516      0.1099             0.0714    7.2800
...
crm_touches          e8b6461a91e2eb2b06e4344f87e39fbf059c28c96738709a88a0f96914228c2b
...
support_tickets      37899ec3a231ab4fbd523e3dc8684c0939fc06b449e7a026406708ed2a2707db
...
```console
2026-09-08 19:22:40,139 INFO    datagen | datagen starting | seed=1729 users_requested=50000 sample_frac=0.004 users_effective=200 months=18 window_start=2025-03-01 window_end=2026-08-31 days=549 target_monthly_churn_rate=0.047 target_reactivation_rate=0.08 power_user_bar=>=4.0 coding hours/day on >=5 days/week campaigns=5 output_format=parquet partitioned=False out_dir=data/sample
2026-09-08 19:22:40,139 INFO    datagen | building population: 200 users, 18 months (2025-03-01 .. 2026-08-31)
2026-09-08 19:22:40,144 INFO    datagen | simulating subscription lifecycle + CRM (calibrating churn hazard)
2026-09-08 19:22:40,276 INFO    datagen | hazard intercept calibrated to -2.20312 in 10 iterations -> monthly churn 0.0470 (target 0.0470)
2026-09-08 19:22:40,276 INFO    datagen | generating usage_events (active days only)
2026-09-08 19:22:40,330 INFO    datagen | usage_events: 43,514 rows
2026-09-08 19:22:40,478 INFO    datagen | users                     200 rows
2026-09-08 19:22:40,478 INFO    datagen | subscriptions             220 rows
2026-09-08 19:22:40,478 INFO    datagen | usage_events           43,514 rows
2026-09-08 19:22:40,478 INFO    datagen | feature_adoption       13,620 rows
2026-09-08 19:22:40,478 INFO    datagen | support_tickets           223 rows
2026-09-08 19:22:40,478 INFO    datagen | crm_campaigns               5 rows
2026-09-08 19:22:40,478 INFO    datagen | crm_touches             1,109 rows
2026-09-08 19:22:40,478 INFO    datagen | churn_labels            2,257 rows
2026-09-08 19:22:40,515 INFO    datagen.writer | wrote users                     200 rows -> 1 file(s)
2026-09-08 19:22:40,518 INFO    datagen.writer | wrote subscriptions             220 rows -> 1 file(s)
2026-09-08 19:22:40,540 INFO    datagen.writer | wrote usage_events           43,514 rows -> 1 file(s)
2026-09-08 19:22:40,555 INFO    datagen.writer | wrote feature_adoption       13,620 rows -> 1 file(s)
2026-09-08 19:22:40,557 INFO    datagen.writer | wrote support_tickets           223 rows -> 1 file(s)
2026-09-08 19:22:40,559 INFO    datagen.writer | wrote crm_campaigns               5 rows -> 1 file(s)
2026-09-08 19:22:40,562 INFO    datagen.writer | wrote crm_touches             1,109 rows -> 1 file(s)
2026-09-08 19:22:40,568 INFO    datagen.writer | wrote churn_labels            2,257 rows -> 1 file(s)
2026-09-08 19:22:40,569 INFO    datagen.writer | wrote manifest -> data/sample/_manifest.json
2026-09-08 19:22:40,569 INFO    datagen.writer | wrote Unity Catalog DDL -> data/sample/_unity_catalog.sql
2026-09-08 19:22:40,595 INFO    datagen | check: referential integrity subscriptions.user_id -> users.user_id: OK
2026-09-08 19:22:40,595 INFO    datagen | check: referential integrity usage_events.user_id -> users.user_id: OK
2026-09-08 19:22:40,595 INFO    datagen | check: referential integrity feature_adoption.user_id -> users.user_id: OK
2026-09-08 19:22:40,595 INFO    datagen | check: referential integrity support_tickets.user_id -> users.user_id: OK
2026-09-08 19:22:40,595 INFO    datagen | check: referential integrity crm_touches.user_id -> users.user_id: OK
2026-09-08 19:22:40,595 INFO    datagen | check: referential integrity churn_labels.user_id -> users.user_id: OK
2026-09-08 19:22:40,595 INFO    datagen | check: referential integrity crm_touches.campaign_id -> crm_campaigns.campaign_id: OK
2026-09-08 19:22:40,595 INFO    datagen | check: primary key users(user_id): OK
2026-09-08 19:22:40,595 INFO    datagen | check: primary key subscriptions(subscription_id): OK
2026-09-08 19:22:40,595 INFO    datagen | check: primary key usage_events(user_id, event_date): OK
2026-09-08 19:22:40,595 INFO    datagen | check: primary key feature_adoption(user_id, feature_key, month_start): OK
2026-09-08 19:22:40,595 INFO    datagen | check: primary key support_tickets(ticket_id): OK
2026-09-08 19:22:40,595 INFO    datagen | check: primary key crm_campaigns(campaign_id): OK
2026-09-08 19:22:40,595 INFO    datagen | check: primary key crm_touches(touch_id): OK
2026-09-08 19:22:40,595 INFO    datagen | check: primary key churn_labels(user_id, month_start): OK
2026-09-08 19:22:40,595 INFO    datagen | check: usage_events.event_date within window: OK
2026-09-08 19:22:40,595 INFO    datagen | check: usage_events value ranges plausible: OK
2026-09-08 19:22:40,595 INFO    datagen | check: monthly churn rate 0.0470 within +/-0.5pt of target 0.0470: OK
2026-09-08 19:22:40,595 INFO    datagen | check: no usage_events after cancellation (non-reactivated users): OK
2026-09-08 19:22:40,595 INFO    datagen | check: churn_labels.churn_date set whenever churned: OK
2026-09-08 19:22:40,595 INFO    datagen | monthly churn rate: 0.0470 (target 0.0470) | users 200 | usage_events 43,514 rows
2026-09-08 19:22:40,595 INFO    datagen | datagen finished | total rows 61,148
```
